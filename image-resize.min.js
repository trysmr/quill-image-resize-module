...
}.call(exports, __webpack_require__(107)))
...
/* WEBPACK VAR INJECTION */(function (module) {
				...
				/* WEBPACK VAR INJECTION */
}.call(exports, __webpack_require__(14)(module)))
			...
			var Resize = function (_BaseModule) {
				...
				function Resize() {
					...
					return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Resize.__proto__ || Object.getPrototypeOf(Resize)).call.apply(_ref, [this].concat(args))), _this), _this.onCreate = function () {
						...
						box.addEventListener('touchstart', _this.handleMousedown, false);
						...
						if (evt.touches) {
							...
							_this.dragStartX = evt.touches[0].clientX;
						} else {
						...
						document.addEventListener('touchend', _this.handleMouseup, false);
						document.addEventListener('touchmove', _this.handleDrag, false);
						...
						var deltaX = void 0;
						if (evt.touches) {
							deltaX = evt.touches[0].clientX - _this.dragStartX;
						} else {
							deltaX = evt.clientX - _this.dragStartX;
						}
